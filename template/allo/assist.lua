...
function fetchSingle(targetVersion, artifactName, path, relDestination)
    ...
    local buildlisturl = "https://dev.azure.com/alloverse/allonet/_apis/build/builds/" .. targetVersion .. "/artifacts?artifactName=" .. artifactName .. "&api-version=5.0&branchName=main&statusFilter=completed&resultFilter=succeeded"
